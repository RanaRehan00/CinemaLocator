...
import {
  SafeAreaView, StyleSheet, Text,Alert, Image, View, FlatList, TouchableOpacity,
} from 'react-native';
...
export default function UserHomeScreen({ route, navigation }) {
  ...
  return (
    <SafeAreaView style={styles.Flex_1}>
      <DoubleTapToClose />
      <Header title="Movies" ticketsButton={bookedTicketPage} menuButton={ ()=>{Alert.alert("Are you sure!",
