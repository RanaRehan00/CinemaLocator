...
export default function Cinema_Movies({ route, navigation }) {
  const [state, setState] = useState([]);
  var DataArray = [];
  var cinemaId= route.params.CinemaId;
  useEffect(() => {
    // console.log("useffect")
    const usersCollection = firestore().collection('Movies');
    usersCollection.where('CinemaId', '==', '' + cinemaId).get()
      .then(
        querySnapshot => {
          ...
          console.log('flatlistArray:', FlatlistData)
          setState();
  ...
  return (
    ...
    {/* \ <Header title="Top Movies" searchButton={getUid} ticketsButton={bookedTicketPage} menuButton={Logoff} /> */}
                  ...
                  navigation.navigate('Select Seats',
                    {
                      ...
                      CinemaNameis: route.params.CinemaName,
                      Time: item.Time,
                      Date: item.Date,
